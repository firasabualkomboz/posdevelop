        ...
        <div class="main_container  main_menu_open">
            ...
            <div class="home_pass hidden-xs">
                <ul>
                    ...
                    <li class="bring_right"><a href="">@lang('site.clients')</a></li>
                </ul>
            </div>
            <!--/End system bath-->
...
{{--                                    <td>{{ is_array($client->phone) ? implode($client->phone, '-') : $client->phone }}</td>--}}
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" href="{{route('dashboard.clients.orders.create',$client->id)}}">@lang('site.add_order')</a>
                                        @else
                                            <a class="btn btn-primary disabled" href="#">@lang('site.add_order')</a>
                                        @endif
...
<td>
                                    ...
                                    @if (auth()->user()->hasPermission('update_clients'))
                                        ...
                                        <a href="{{ route('dashboard.clients.orders.create', $client->id) }}" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i> @lang('site.edit')</a>
